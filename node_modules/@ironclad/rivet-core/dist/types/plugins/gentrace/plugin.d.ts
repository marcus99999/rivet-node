...
export declare const getGentracePipelines: (gentraceApiKey: string) => Promise<import("@gentrace/core/dist/models/pipelines-get200-response-pipelines-inner.js").PipelinesGet200ResponsePipelinesInner[]>;
