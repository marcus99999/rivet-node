...
const V1ApiAxiosParamCreator = function (configuration) {
    return {
        ...
        v1FeedbackPost: (feedbackRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common.assertParamExists("v1FeedbackPost", "feedbackRequest", feedbackRequest);
            ...
            localVarRequestOptions.data = common.serializeDataIfNeeded(feedbackRequest, localVarRequestOptions, configuration);
            return {
        ...
        v1TestResultIdPost: (id, v1TestResultIdPostRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            common.assertParamExists("v1TestResultIdPost", "id", id);
            // verify required parameter 'v1TestResultIdPostRequest' is not null or undefined
            common.assertParamExists("v1TestResultIdPost", "v1TestResultIdPostRequest", v1TestResultIdPostRequest);
            const localVarPath = `/v1/test-result/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common.DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = common.serializeDataIfNeeded(v1TestResultIdPostRequest, localVarRequestOptions, configuration);
            return {
                url: common.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        v1TestResultSimpleIdPost: (id, v1TestResultSimpleIdPostRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            common.assertParamExists("v1TestResultSimpleIdPost", "id", id);
            // verify required parameter 'v1TestResultSimpleIdPostRequest' is not null or undefined
            common.assertParamExists("v1TestResultSimpleIdPost", "v1TestResultSimpleIdPostRequest", v1TestResultSimpleIdPostRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = common.serializeDataIfNeeded(v1TestResultSimpleIdPostRequest, localVarRequestOptions, configuration);
            return {
                url: common.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
