...
export declare const V1ApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    v1TestCaseGet(datasetId?: string, pipelineId?: string, pipelineSlug?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1TestCaseGet200Response>>;
    /**
     *
     * @summary Update an existing test case
     * @param {UpdateTestCase} updateTestCase
     ...
     * @throws {RequiredError}
     */
    v1TestResultIdPost(id: string, v1TestResultIdPostRequest: V1TestResultIdPostRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1TestResultPost200Response>>;
    /**
     *
     * @summary Create a new test result from runs
     * @param {V1TestResultPostRequest} v1TestResultPostRequest
     ...
     * @throws {RequiredError}
     */
    v1TestResultSimpleIdPost(id: string, v1TestResultSimpleIdPostRequest: V1TestResultSimpleIdPostRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1TestResultPost200Response>>;
    /**
     *
     * @summary Create a new test result from test runs
     * @param {V1TestResultSimplePostRequest} v1TestResultSimplePostRequest
...
export declare const V1ApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    v1TestCaseGet(datasetId?: string, pipelineId?: string, pipelineSlug?: string, options?: any): AxiosPromise<V1TestCaseGet200Response>;
    /**
     *
     * @summary Update an existing test case
     * @param {UpdateTestCase} updateTestCase
     ...
     * @throws {RequiredError}
     */
    v1TestResultIdPost(id: string, v1TestResultIdPostRequest: V1TestResultIdPostRequest, options?: any): AxiosPromise<V1TestResultPost200Response>;
    /**
     *
     * @summary Create a new test result from runs
     * @param {V1TestResultPostRequest} v1TestResultPostRequest
     ...
     * @throws {RequiredError}
     */
    v1TestResultSimpleIdPost(id: string, v1TestResultSimpleIdPostRequest: V1TestResultSimpleIdPostRequest, options?: any): AxiosPromise<V1TestResultPost200Response>;
    /**
     *
     * @summary Create a new test result from test runs
     * @param {V1TestResultSimplePostRequest} v1TestResultSimplePostRequest
...
export declare class V1Api extends BaseAPI {
     ...
     * @memberof V1Api
     */
    v1FeedbackPost(feedbackRequest: FeedbackRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<FeedbackResponse, any>>;
    /**
     *
     * @summary Upload an image file
     * @param {string} [org] (If not using an organization API Key) the ID of the organization
     ...
     * @memberof V1Api
     */
    v1TestCaseGet(datasetId?: string, pipelineId?: string, pipelineSlug?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<V1TestCaseGet200Response, any>>;
    /**
     *
     * @summary Update an existing test case
     * @param {UpdateTestCase} updateTestCase
     ...
     * @memberof V1Api
     */
    v1TestResultIdPost(id: string, v1TestResultIdPostRequest: V1TestResultIdPostRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<V1TestResultPost200Response, any>>;
    /**
     *
     * @summary Create a new test result from runs
     * @param {V1TestResultPostRequest} v1TestResultPostRequest
     ...
     * @memberof V1Api
     */
    v1TestResultSimpleIdPost(id: string, v1TestResultSimpleIdPostRequest: V1TestResultSimpleIdPostRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<V1TestResultPost200Response, any>>;
    /**
     *
     * @summary Create a new test result from test runs
     * @param {V1TestResultSimplePostRequest} v1TestResultSimplePostRequest
