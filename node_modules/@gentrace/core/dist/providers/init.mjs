...
function init(values) {
    const { apiKey, basePath, branch, commit, showConnectionErrors, runName, resultName, } = values !== null && values !== void 0 ? values : {};
...
export { GENTRACE_API_KEY, GENTRACE_BASE_PATH, GENTRACE_BRANCH, GENTRACE_COMMIT, GENTRACE_RESULT_NAME, GENTRACE_RUN_NAME, GENTRACE_SHOW_CONNECTION_ERRORS, deinit, flush, getGentraceApiKey, getGentraceBasePath, globalGentraceApi, globalGentraceApiV2, globalGentraceConfig, globalRequestBuffer, init, resetGlobalGentraceApi };
