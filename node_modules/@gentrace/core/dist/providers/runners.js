...
const getTestRunners = (pipeline, datasetId, caseFilter) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let response;
    if (datasetId) {
        response = yield init.globalGentraceApi.v1TestCaseGet(datasetId, undefined, undefined);
    }
    else if (pipeline.id) {
        response = yield init.globalGentraceApi.v1TestCaseGet(undefined, pipeline.id, undefined);
    }
    else {
        response = yield init.globalGentraceApi.v1TestCaseGet(undefined, undefined, pipeline.slug);
    }
...
function submitTestRunners(pipeline, pipelineRunTestCases, contextOrCaseFilter, caseFilterOrUndefined) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const body = testResult.constructSubmissionPayloadAdvanced((_a = pipeline.id) !== null && _a !== void 0 ? _a : pipeline.slug, testRuns, context);
...
function updateTestResultWithRunners(resultId, runners) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield init.globalGentraceApi.v1TestResultIdPost(resultId, {
            testRuns,
        });
        return response.data;
    });
...
exports.getTestRunners = getTestRunners;
exports.submitTestRunners = submitTestRunners;
exports.updateTestResultWithRunners = updateTestResultWithRunners;
