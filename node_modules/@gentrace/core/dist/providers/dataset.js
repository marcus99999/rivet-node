...
const getDatasets = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield init.globalGentraceApiV2.v2DatasetsGet(params === null || params === void 0 ? void 0 : params.pipelineSlug, params === null || params === void 0 ? void 0 : params.pipelineId, params === null || params === void 0 ? void 0 : params.archived);
...
const createDataset = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield init.globalGentraceApiV2.v2DatasetsPost(payload);
...
const getDataset = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield init.globalGentraceApiV2.v2DatasetsIdGet(id);
    return response.data;
});
/**
...
const updateDataset = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield init.globalGentraceApiV2.v2DatasetsIdPost(id, payload);
    return response.data;
});
