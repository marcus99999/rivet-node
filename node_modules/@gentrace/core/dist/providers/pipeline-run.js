...
const getRun = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield init.globalGentraceApiV2.v2RunsIdGet(id);
...
class PipelineRun {
    ...
    checkpoint(step) {
        ...
        if (lastElement) {
            ...
            this.stepRuns.push(new stepRun.StepRun((_a = step.providerName) !== null && _a !== void 0 ? _a : "undeclared", (_b = step.invocation) !== null && _b !== void 0 ? _b : "undeclared", elapsedTime, stepStartTime, endTimeNew, step.inputs, (_c = step.modelParams) !== null && _c !== void 0 ? _c : {}, step.outputs, (_d = step.context) !== null && _d !== void 0 ? _d : {}));
        }
        else {
            const endTime = new Date().toISOString();
            const elapsedTime = new Date(endTime).getTime() -
                new Date(this.instantiationTime).getTime();
            this.stepRuns.push(new stepRun.StepRun((_e = step.providerName) !== null && _e !== void 0 ? _e : "undeclared", (_f = step.invocation) !== null && _f !== void 0 ? _f : "undeclared", elapsedTime, this.instantiationTime, endTime, step.inputs, (_g = step.modelParams) !== null && _g !== void 0 ? _g : {}, step.outputs, (_h = step.context) !== null && _h !== void 0 ? _h : {}));
        }
    }
    /**
    ...
    measure(func, inputs, stepInfo) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.stepRuns.push(new stepRun.StepRun((_a = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.providerName) !== null && _a !== void 0 ? _a : "undeclared", (_b = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.invocation) !== null && _b !== void 0 ? _b : "undeclared", elapsedTime, new Date(startTime).toISOString(), new Date(endTime).toISOString(), resolvedInputs, (_c = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.modelParams) !== null && _c !== void 0 ? _c : {}, modifiedOutput, (_d = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.context) !== null && _d !== void 0 ? _d : {}));
            return returnValue;
        });
    }
    toObject() {
    ...
    static getRedactedRunFromJson(json, options) {
        ...
        const pipelineRunObject = (typeof json === "string" ? utils.safeJsonParse(json) : json);
    ...
    static submitFromJson(json, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const api = new v1Api.V1Api(pipeline ? pipeline.config : init.globalGentraceConfig);
            ...
            if (!waitForServer) {
                init.globalRequestBuffer[pipelineRunObject.id] = submission;
                submission
                    .catch((e) => {
                    if (pipeline) {
                        pipeline.logWarn(e);
                    ...
                    .finally(() => {
                    delete init.globalRequestBuffer[pipelineRunObject.id];
                });
                const data = {
