...
import { Pipeline, constructSubmissionPayloadAdvanced, createTestCase, createTestCases, getPipelines, getTestCases, getTestResults, runTest, submitTestResult, updateTestCase, getTestCase, } from "../providers";
...
describe("Usage of Evaluation functionality", () => {
    ...
    beforeAll(() => {
        ...
        }), rest.get("https://gentrace.ai/api/v2/test-cases/87cca81f-f466-4433-a0d2-695c06d1355a", (req, res, ctx) => {
            return res(ctx.status(200), ctx.set("Content-Type", "application/json"), ctx.json(getTestCaseResponse));
        }));
        server.listen();
    });
    afterAll(() => {
    ...
    describe("constructor", () => {
        ...
        it("should pull test case correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            init({
                apiKey: "gentrace-api-key",
                basePath: "https://gentrace.ai/api",
            });
            const testCase = yield getTestCase(getTestCaseResponse.id);
